# Task record: WP01-T10 write operation tutorial
...
**Reviewer:** Codex `/root` for documentation candidate; final clean database rehearsal blocked on WP01-T04

**Branch:** main (no delivery branch requested)

**Updated (UTC):** 2026-08-20T17:56:00Z

## Execution contract

**Dependencies:** WP01-T01/T02/T03/T06 reviewed PASS; current package commands and workflow authorities; final local-stack rehearsal depends on WP01-T04/T05/T07.

**Inputs:** Runbook WP01-T10; root repository map; agent workflow; environment contract; module boundaries; actual package scripts; current Docker blocker evidence.

**Files:** `CONTRIBUTING.md`, root README link, task/runbook state, and eventual WP01 foundation evidence.

**Verify:** Link/name/readiness checks; command-table parity with `package.json`; isolated clean-snapshot discovery and non-database commands; full daily/end-session walkthrough after WP01-T04 passes.

**Pass:** A clean agent reaches the app, local database, tests, build, and complete handoff from the tutorial alone, with every ambiguity recorded and corrected.
...
**Hard stop:** Do not document an unimplemented command as passing, hide the Docker/virtualization blocker, include a secret, suggest destructive migration repair, weaken review gates, or claim the final rehearsal before the database stack works.

## Steps

- [x] Inventory actual commands, setup prerequisites, authorities, and known blockers.
- [x] Write the setup, daily operation, branch/PR/migration, verification, troubleshooting, and handoff tutorial.
...
- [?] Rehearse the full local database/app journey after WP01-T04 and close review.
